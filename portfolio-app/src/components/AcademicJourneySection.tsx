    ...
    <section id="journey" className="py-24 relative bg-[#070709] border-t border-white/[0.06]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="absolute left-4 sm:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-[#00f0ff] via-[#8b5cf6] to-white/10 -translate-x-1/2" />
            ...
            {educationList.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Center Node / Dot */}
                  <div className="absolute left-4 sm:left-1/2 top-6 -translate-x-1/2 w-7 h-7 rounded-full border-2 border-[#00f0ff] bg-[#070709] flex items-center justify-center z-10 shadow-lg shadow-[#00f0ff]/20">
                  ...
                  <div className="w-full sm:w-1/2 pl-10 sm:pl-0">
                    <div className="p-6 rounded-2xl border border-white/10 bg-gradient-to-b from-[#111420] to-[#0a0c13] hover:border-[#00f0ff]/30 transition-all duration-300 shadow-xl group">
