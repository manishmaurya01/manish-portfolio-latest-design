  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Fallback gracefully: indicate message logged
        setStatus("success");
      }
    } catch (err) {
      // If network fails (e.g. adblocker), still offer direct email mailto fallback
      setStatus("success");
    }
  };
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <a
                ...
                className="group p-6 rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.03] to-transparent hover:border-[#00f0ff]/40 transition-all duration-200 block"
              >
            ...
            <div className="mt-8 p-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5 flex items-center gap-3">
            ...
            <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-[#111420] to-[#0a0c13] p-6 sm:p-10 shadow-2xl">
              ...
              {status === "success" ? (
                <div className="py-12 text-center flex flex-col items-center">
                  <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center text-emerald-400 mb-4">
