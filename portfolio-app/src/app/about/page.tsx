...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex flex-col overflow-hidden transition-colors duration-200">
      ...
      <div
        className="absolute top-28 left-1/2 -translate-x-1/2 w-[700px] h-[550px] bg-gradient-to-tr from-amber-500/10 via-orange-600/5 to-transparent rounded-full blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      <div
        className="absolute top-1/2 right-10 w-[450px] h-[450px] bg-amber-500/5 rounded-full blur-3xl pointer-events-none"
        aria-hidden="true"
      />
      ...
      <main className="relative z-10 flex-1 pt-32 pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-xs font-mono text-stone-500 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors p-2 -ml-2 rounded-lg hover:bg-stone-100 dark:hover:bg-white/5"
            >
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="p-6 sm:p-8 rounded-3xl border border-stone-200 dark:border-white/10 bg-white dark:bg-[#18181b]/80 backdrop-blur-xl shadow-sm dark:shadow-xl">
                ...
                <div className="space-y-4 text-stone-600 dark:text-stone-300 text-sm sm:text-base leading-relaxed">
                  <p>
                    I’m <strong className="text-stone-900 dark:text-white">Manish Kumar</strong>, a full-stack engineer and UI/UX designer based in Gujarat, India. Currently, I am pursuing my <strong className="text-amber-600 dark:text-amber-400">Master of Computer Applications (MCA)</strong> at Parul University, Vadodara, following the completion of my BCA at Hemchandracharya North Gujarat University (HNGU) with Distinction (7.56 CGPA).
                  </p>
                  <p>
                    My technical work balances frontend craftsmanship with robust backend engineering. I build scalable applications with <strong className="text-stone-900 dark:text-white">React.js, Next.js, Node.js, and MySQL/Firebase</strong>, coupled with modern design systems and automated webhook workflows using <strong className="text-amber-700 dark:text-amber-300">n8n</strong>.
                  </p>
                  <p>
              ...
              <div className="p-6 sm:p-8 rounded-3xl border border-stone-200 dark:border-white/10 bg-stone-50/80 dark:bg-gradient-to-r dark:from-[#18181b]/80 dark:via-[#141418]/85 dark:to-[#18181b]/80 backdrop-blur-xl flex flex-col sm:flex-row items-center gap-6 shadow-sm">
                ...
                <div>
                  <h3 className="text-base font-bold text-stone-900 dark:text-white font-display mb-2 flex items-center gap-2">
                    <Code2 className="w-4 h-4 text-amber-600 dark:text-amber-400" />
                    <span>Core Technical Focus</span>
                  </h3>
                  <p className="text-stone-600 dark:text-stone-300 text-xs sm:text-sm leading-relaxed mb-3">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {["React.js", "Next.js", "Tailwind CSS", "Node.js", "MySQL", "n8n Automation", "Three.js"].map((t, i) => (
                      <span key={i} className="text-[10px] font-mono px-2.5 py-1 rounded-md bg-white dark:bg-white/[0.04] text-stone-700 dark:text-stone-300 border border-stone-200 dark:border-white/5 shadow-xs">
                        {t}
                      </span>
                    ))}
                  </div>
              ...
              <div className="p-6 sm:p-8 rounded-3xl border border-stone-200 dark:border-white/10 bg-white dark:bg-[#18181b]/80 backdrop-blur-xl space-y-6 shadow-sm dark:shadow-xl">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono text-stone-500 dark:text-stone-400 font-medium">Formal Degrees</span>
                </div>
                ...
                <div className="space-y-4">
                  {educationList.map((edu, idx) => (
                    <div
                      key={idx}
                      className="p-4 rounded-2xl border border-stone-200 dark:border-white/5 bg-stone-50 dark:bg-white/[0.02] hover:border-amber-500/40 transition-all"
                    >
                      <div className="flex flex-wrap items-center justify-between gap-2 mb-1">
                        <h3 className="text-sm sm:text-base font-bold text-stone-900 dark:text-white font-display">
                          {edu.degree}
                        </h3>
                        <span className="text-[11px] font-mono text-amber-700 dark:text-amber-300 px-2.5 py-0.5 rounded-full border border-amber-500/20 bg-amber-500/10 font-semibold">
                          {edu.period}
                        </span>
                      </div>
